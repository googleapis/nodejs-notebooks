...
describe('v1.NotebookServiceClient', () => {
    ...
    describe('updateInstanceMetadataItems', () => {
        it('invokes updateInstanceMetadataItems without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.notebooks.v1.UpdateInstanceMetadataItemsRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.notebooks.v1.UpdateInstanceMetadataItemsResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateInstanceMetadataItems as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
