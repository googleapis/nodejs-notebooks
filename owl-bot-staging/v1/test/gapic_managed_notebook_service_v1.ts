...
describe('v1.ManagedNotebookServiceClient', () => {
    ...
    describe('getRuntime', () => {
        it('invokes getRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRuntimeRequest', ['name']);
    ...
    describe('refreshRuntimeTokenInternal', () => {
        it('invokes refreshRuntimeTokenInternal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RefreshRuntimeTokenInternalRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createRuntime', () => {
        it('invokes createRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateRuntimeRequest', ['parent']);
    ...
    describe('deleteRuntime', () => {
        it('invokes deleteRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('startRuntime', () => {
        it('invokes startRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StartRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('stopRuntime', () => {
        it('invokes stopRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StopRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('switchRuntime', () => {
        it('invokes switchRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SwitchRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('resetRuntime', () => {
        it('invokes resetRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ResetRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('reportRuntimeEvent', () => {
        it('invokes reportRuntimeEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ReportRuntimeEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
